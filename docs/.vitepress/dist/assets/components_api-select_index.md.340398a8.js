...
`),t("span",{class:"token punctuation"},"}"),n(`
`)])]),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"</"),n("script")]),t("span",{class:"token punctuation"},">")]),n(`
`)])])],-1),P=t("h2",{id:"\u914D\u5408searchform",tabindex:"-1"},[n("\u914D\u5408SearchForm "),t("a",{class:"header-anchor",href:"#\u914D\u5408searchform","aria-hidden":"true"},"#")],-1);function q(p,r,i,k,d,g){const o=x("render-demo-0"),s=x("demo"),h=x("render-demo-1");return B(),C("div",null,[D,A,w,S,m(s,{sourceCode:`<template>
